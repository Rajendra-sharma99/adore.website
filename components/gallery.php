                ...
                <div class="gallery-items row">
                    ...
                    <div class="col-lg-4 col-sm-6 single-item marketing wordpress">
                        <div class="gallery-wrap">
                            ...
                            <div class="hover">
                                <a class="img-popup" data-gall="galleryimg" href="assets/img/gallery-2.jpg"><i class="ti-image"></i></a> 
                            </div>
                        </div>
                    </div><!-- /Item-2 -->
                    <div class="col-lg-4 col-sm-6 single-item wordpress design branding">
                        <div class="gallery-wrap">
                            ...
                            <div class="hover">
                                <a class="img-popup" data-gall="galleryimg" href="assets/img/gallery-3.jpg"><i class="ti-image"></i></a> 
                            </div>
                        </div>
                    </div><!-- /Item-3 -->
                    <div class="col-lg-4 col-sm-6 single-item design branding wordpress">
                        <div class="gallery-wrap">
                            ...
                            <div class="hover">
                                <a class="img-popup" data-gall="galleryimg" href="assets/img/gallery-4.jpg"><i class="ti-image"></i></a> 
                            </div>
                        </div>
                    </div><!-- /Item-4 -->
                    <div class="col-lg-4 col-sm-6 single-item branding marketing">
                        <div class="gallery-wrap">
                            ...
                            <div class="hover">
                                <a class="img-popup" data-gall="galleryimg" href="assets/img/gallery-5.jpg"><i class="ti-image"></i></a> 
                            </div>
                        </div>
                    </div><!-- /Item-5 -->
                    <div class="col-lg-4 col-sm-6 single-item marketing design">
                        <div class="gallery-wrap">
                            ...
                            <div class="hover">
                                <a class="img-popup" data-gall="galleryimg" href="assets/img/gallery-6.jpg"><i class="ti-image"></i></a> 
                            </div>
                        </div>
                    </div><!-- /Item-6 -->
                </div>
